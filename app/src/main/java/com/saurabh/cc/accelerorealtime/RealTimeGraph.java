package com.saurabh.cc.accelerorealtime;
...
public class RealTimeGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SGolayFilter sGolayFilter =new SGolayFilter(4,15);
        double[]filteredData=new double[200];
        for (int i=15;i<data.size();i++){
            filteredData[i-15]= sGolayFilter.GetFiltredData(GetFrameData(i,15,data));
        }
        for(int i=0;i<15;i++){
